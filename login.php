...
// }else{
//     echo "<script>alert('isset Gabisa !!');</script>";
// }
        ...
        <div class="container-lg">
          <div class="row justify-content-center">
            <div class="col-sm-8 col-md-9 col-xl-5 text-center pt-8">
              <div class="wrapper">
                <div class="text-center name"> Sign In </div>
                <form class="p-3 mt-3" action="login.php" method="POST">
                    ...
                    <div class="form-field d-flex align-items-center"> <span class="fas fa-key"></span> <input type="password" name="password" id="password" placeholder="Password" required=""> 
                    </div>
                    <button class="btn mt-3" type="submit" name="submit">Sign In</button>
                    <!-- <input class="btn mt-3" type="submit" value="Sign in" /> -->
                </form>
